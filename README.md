...
| Theorem-grade signed tile (rigorous TM pair layer, graded results) | **Demonstrated 5/5 across θ** (rigor_tile.py; enumeration coverage the sole SAMPLED dependency; 1.6 s/tile chained) |
